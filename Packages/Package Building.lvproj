...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Package Building Launcher.lvlib" Type="Library" URL="../Pacjage Building Launcher/Package Building Launcher.lvlib"/>
		<Item Name="Package Building.lvlib" Type="Library" URL="../Pacjage Building/Package Building.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Package Building Launcher.lvlib/Splash Screen.vi</Property>
				<Property Name="Source[1].sourceInclusion" Type="Str">TopLevel</Property>
				<Property Name="Source[1].type" Type="Str">VI</Property>
				<Property Name="Source[2].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[2].itemID" Type="Ref">/My Computer/Package Building.lvlib</Property>
			...
			<Item Name="Services Package" Type="{E661DAE2-7517-431F-AC41-30807A3BDA38}">
				<Property Name="NIPKG_license" Type="Ref"></Property>
				<Property Name="NIPKG_releaseNotes" Type="Str"></Property>
				<Property Name="PKG_actions.Count" Type="Int">0</Property>
				<Property Name="PKG_autoIncrementBuild" Type="Bool">true</Property>
				<Property Name="PKG_buildNumber" Type="Int">0</Property>
				<Property Name="PKG_buildSpecName" Type="Str">Services Package</Property>
				...
				<Property Name="PKG_dependencies[0].NIPKG.DisplayName" Type="Str">NI-DMM Configuration Support for NI 408x DMMs</Property>
				<Property Name="PKG_dependencies[0].Package.Name" Type="Str">ni-dmm-config-408x-devices</Property>
				<Property Name="PKG_dependencies[0].Package.Section" Type="Str">Drivers</Property>
				<Property Name="PKG_dependencies[0].Package.Synopsis" Type="Str">Provides NI-DMM support for configuring NI 408x DMMs via Measurement &amp; Automation Explorer (MAX). Refer to the NI-DMM readme on ni.com/manuals for a full list of supported hardware.</Property>
				...
				<Property Name="PKG_dependencies[1].NIPKG.DisplayName" Type="Str">NI-DMM Runtime for NI 408x DMMs</Property>
				<Property Name="PKG_dependencies[1].Package.Name" Type="Str">ni-dmm-runtime-408x-devices</Property>
				<Property Name="PKG_dependencies[1].Package.Section" Type="Str">Drivers</Property>
				<Property Name="PKG_dependencies[1].Package.Synopsis" Type="Str">Provides run-time components required to deploy applications using NI 408x DMMs. Refer to the NI-DMM readme on ni.com/manuals for a full list of supported hardware.</Property>
				...
				<Property Name="PKG_destinations[0].ID" Type="Str">{7F7F95B6-3160-463B-A54D-C6F19C34B240}</Property>
				<Property Name="PKG_destinations[0].Subdir.Directory" Type="Str">Package Building</Property>
				...
				<Property Name="PKG_output" Type="Path">../builds/NI_AB_PROJECTNAME/Services Package</Property>
				<Property Name="PKG_output.Type" Type="Str">relativeToCommon</Property>
				<Property Name="PKG_packageName" Type="Str">package-building</Property>
				...
				<Property Name="PKG_shortcuts[0].Path" Type="Path">Package Building</Property>
				<Property Name="PKG_shortcuts[0].TargetChild" Type="Str">{5A10077A-E1A4-4DC4-9F06-62153E5D6EC7}</Property>
				<Property Name="PKG_shortcuts[0].TargetDest" Type="Str">root_0</Property>
				<Property Name="PKG_shortcuts[0].TargetSource" Type="Ref">/My Computer/Build Specifications/Application</Property>
				...
				<Property Name="PKG_synopsis" Type="Str">Package Building</Property>
